...
去 [github.com/adriankumpf/tesla_auth/releases](https://github.com/adriankumpf/tesla_auth/releases) 下载对应平台二进制：
- **macOS（M1/M2/M3）**：`tesla_auth-aarch64-apple-darwin.tar.xz`
- **macOS（Intel）**：`tesla_auth-x86_64-apple-darwin.tar.xz`
- **Windows**：`tesla_auth-x86_64-pc-windows-msvc.zip`
- **Linux**：`tesla_auth-x86_64-unknown-linux-gnu.tar.xz`（或 aarch64 ARM 版）
